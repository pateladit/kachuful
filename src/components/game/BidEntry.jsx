...
export default function BidEntry({
  ...
  useEffect(() => () => { if (shakeBtnTimerRef.current) clearTimeout(shakeBtnTimerRef.current) }, [])
  ...
  return (
    <>
      <div style={{ maxWidth: 1360, margin: '0 auto', padding: '24px 32px 32px', minHeight: '100vh', display: 'grid', gridTemplateRows: 'auto auto auto auto', gap: 20 }}>
        ...
        <div className="game-content">
          ...
          <section style={{ background: V.surface, border: `1px solid ${V.line}`, borderRadius: 20, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        padding: isDone ? '5px 12px 5px 8px' : '6px 12px',
                    ...
                    >
                      ...
                      {isDone ? (
                        ...
                        <>
                          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: 13, color: V.ink, whiteSpace: 'nowrap' }}>
                            {p.displayName}
                          </span>
            ...
            {activePlayer ? (
              <div style={{ padding: '28px 32px 22px', background: `color-mix(in oklab, ${activePlayer.color} 6%, transparent)`, flex: 1 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20, marginBottom: 22 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {/* Forbidden notice — own row, prominent */}
                    {activeForbidden !== null ? (
                  ...
                  {activeBid !== undefined ? (
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
                      <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 52, color: activeBid === 0 ? V.accent3 : V.ink, letterSpacing: '-0.03em', lineHeight: 1, fontVariantNumeric: 'tabular-nums' }}>
                        {activeBid}
                      </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'var(--font-mono)', fontSize: 12, tableLayout: 'fixed' }}>
                <thead>
                  <tr>
                    ...
                    >Rnd</th>
                    {players.map((p, i) => (
                      <th key={p.id} style={{ padding: '9px 4px', background: V.surface, textAlign: 'center', borderBottom: `1px solid ${V.line}`, borderRight: i < players.length - 1 ? `1px solid ${V.line}` : 'none' }}>
